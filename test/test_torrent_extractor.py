#!/usr/bin/python3
# Run the tests from the project root (torrent_extractor) with: python3 -m unittest discover --pattern=test_*
...
class TorrentExtractorTest(unittest.TestCase):
    ...
    def test_copying(self):
        for download in self.downloads:
            cmd = r'python3 ../run_torrent_extractor.py -t /media/axel/test/tv_series -f /media/axel/test/films "' + self.path + download[0] + '"'
    ...
    def test_permission_checks(self):
        noWriteToTv = r'python3 ../run_torrent_extract.r.py -d -t /root "' + self.path + self.downloads[0][0] + '"'
        noWriteToFilm = r'python3 ../run_torrent_extractor.py -d -f /root "' + self.path + self.downloads[0][0] + '"'
        noWriteToLog = r'python3 ../run_torrent_extractor.py -d -l /root -f /media/axel/test/films "' + self.path + self.downloads[0][0] + '"'
